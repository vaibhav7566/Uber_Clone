...
const ConfirmRidePopup = (props) => {
  return (
    <div >
      ...
      <h3 className="text-2xl font-semibold mb-6 flex items-center justify-center ">Confirm this ride to Start</h3>
      ...
      <div className="flex justify-between items-center flex-col gap-2">
        ...
        <button
          onClick={() => {}}
          className="w-full mt-3 bg-green-600 font-semibold text-white py-2 rounded-lg"
        >
          Confirm
        </button>
        ...
        to={"/driver/riding"}
          ...
          className="w-full mt-2 bg-red-500 font-semibold text-white flex justify-center py-2 rounded-lg"
        >
          Cancel
        </Link>
      </div>
